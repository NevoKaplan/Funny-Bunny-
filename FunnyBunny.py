...
sen_choice = ["burned in a fire. He's dead.", "was sent to the abyss.", "is an asshole. He's with god now.",
              ...
              "dead, sorry.", "fell out of the world.", "is playing Bibi's Adventure, we'll leave him alone.",
...
def run():
    ...
    while nm:
        ...
        if players_num != "0" and players_num.isnumeric():
